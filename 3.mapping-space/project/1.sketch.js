...
function setup() {
    ...
    text(`Largest Magnitude: ${columnMax(table, "maximum_magnitude")}`, 20, 60)
...
function addCircles(){
    ...
    var magnitudeMax = columnMax(table, "maximum_magnitude");
    console.log('magnitude range:', [magnitudeMin, magnitudeMax])

    // var depthMin = 0.0;
    // var depthMax = columnMax(table, "maximum_magnitude");
    // console.log('maximum_magnitude:', [depthMin, depthMax])
